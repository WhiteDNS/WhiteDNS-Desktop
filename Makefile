...
$(error --version requires a value; use `make all -- --version 1.1.1`)
endif
endif
...
help:
	@printf '%s\n' \
		...
		'  make all VERSION=1.1.1         Build release assets with this version' \
		'  make all -- --version 1.1.1    Alternate flag form' \
