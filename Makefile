...
$(error --version requires a value; use `make all -- --version 1.1.0`)
endif
endif
...
help:
	@printf '%s\n' \
		...
		'  make all VERSION=1.1.0         Build release assets with this version' \
		'  make all -- --version 1.1.0    Alternate flag form' \
