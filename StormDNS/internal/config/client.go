...
func finalizeClientConfig(cfg ClientConfig) (ClientConfig, error) {
	...
	cfg.UploadPacketDuplicationCount = clampInt(defaultIntBelow(cfg.UploadPacketDuplicationCount, 1, 3), 1, 90)
	cfg.DownloadPacketDuplicationCount = clampInt(defaultIntBelow(cfg.DownloadPacketDuplicationCount, 1, 7), 1, 90)
	...
	cfg.UploadSetupPacketDuplicationCount = clampInt(defaultIntBelow(cfg.UploadSetupPacketDuplicationCount, 1, 4), cfg.UploadPacketDuplicationCount, 90)
	cfg.DownloadSetupPacketDuplicationCount = clampInt(defaultIntBelow(cfg.DownloadSetupPacketDuplicationCount, 1, 8), cfg.DownloadPacketDuplicationCount, 90)
