...
`WhiteDNS-Desktop-1.2.1-windows-x64.zip`
...
`WhiteDNS-Desktop-1.2.1-windows-arm64-windows-on-arm.zip`
...
`WhiteDNS-Desktop-1.2.1-macos-arm64.zip`

### مک‌های Intel

اگر مک شما قدیمی‌تر و Intel است، این فایل را دانلود کنید:

`WhiteDNS-Desktop-1.2.1-macos-amd64.zip`
...
`WhiteDNS-Desktop-1.2.1-linux-amd64-webkit41.AppImage`
