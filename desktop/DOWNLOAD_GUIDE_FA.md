...
`WhiteDNS-Desktop-1.1.4-windows-x64.zip`
...
`WhiteDNS-Desktop-1.1.4-windows-arm64-windows-on-arm.zip`
...
`WhiteDNS-Desktop-1.1.4-macos-arm64.zip`

### مک‌های Intel

اگر مک شما قدیمی‌تر و Intel است، این فایل را دانلود کنید:

`WhiteDNS-Desktop-1.1.4-macos-amd64.zip`
...
`WhiteDNS-Desktop-1.1.4-linux-amd64-webkit41.AppImage`
