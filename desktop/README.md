...
Pass the release version with `VERSION=1.0.0`, or use the GNU-make-safe flag form `make all -- --version 1.0.0`. Release staging writes platform folders under `build/releases/all/` and versioned compressed assets such as `WhiteDNS-Desktop-1.1.2-macos-arm64.zip`.
