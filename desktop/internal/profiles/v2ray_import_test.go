...
http-proxy://user:pass@http.example.com:8080?headers=%7B%22User-Agent%22%3A%22WhiteDNS%22%7D#HTTP`
	...
	if profiles[3].Protocol != model.V2RayProtocolHTTP || profiles[3].HTTPHeaders != `{"User-Agent":"WhiteDNS"}` {
